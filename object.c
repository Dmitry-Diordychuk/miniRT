...
/*   Updated: 2020/09/04 15:42:09 by kdustin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	create_sphere((t_point3d){0, -1, 4}, 1), (t_color3d){0, 0, 255}, 1000)))
//	{
//		ft_lstclear(&objects, delete_object);
//		return (NULL);
//	}
...
//
	...
	create_cylinder((t_point3d){0,0,3}, (t_vector3d){0.7, 0.7, 0}, 1, 2), (t_color3d){90, 90, 180}, 800)))
	{
		ft_lstclear(&objects, delete_object);
		return (NULL);
	}
